...
Movies.o:               Movies.f90          FileIO.f90 Output.f90
...
DownhillSimplex.o:      DownhillSimplex.f90 FileIO.f90 ObjectFunctions.o
Qfep.o:                 Qfep.f90            Data.o StatisticalFunctions.o FileIO.o FreeEnergy.o Util.o
Fepcat.o:               Fepcat.f90          Data.o Input.o Log.o Analysis.o Util.o DownhillSimplex.o

Fepcat:   Fepcat.o Input.o Output.o Data.o FileIO.o Analysis.o StatisticalFunctions.o FreeEnergy.o Log.o ArrayUtil.o Matrix.o DCDHeader.o DCDFiles.o InternalCoords.o Util.o Movies.o DownhillSimplex.o ObjectFunctions.o

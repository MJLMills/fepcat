...
EVBParameters.o:        EVBParameters.f90   Data.o Input.o FreeEnergy.o
...
Fep2D.o:                Fep2D.f90           Analysis.o Util.o
FreeEnergy.o:           FreeEnergy.f90      Data.o Input.o StatisticalFunctions.o ArrayUtil.o
ObjectFunctions.o:      ObjectFunctions.f90 FreeEnergy.o Input.o Data.o Analysis.o
DownhillSimplex.o:      DownhillSimplex.f90 FileIO.o ObjectFunctions.o
Qfep.o:                 Qfep.f90            Data.o StatisticalFunctions.o FileIO.o FreeEnergy.o Util.o
Fepcat.o:               Fepcat.f90          Data.o Input.o Log.o Analysis.o Util.o DownhillSimplex.o EVBParameters.o

Fepcat:   Fepcat.o Input.o Output.o Data.o FileIO.o Analysis.o StatisticalFunctions.o FreeEnergy.o Log.o ArrayUtil.o Matrix.o DCDHeader.o DCDFiles.o InternalCoords.o Util.o Movies.o DownhillSimplex.o ObjectFunctions.o EVBParameters.o
...
FepMovie: FepMovie.o Util.o Data.o Movies.o Log.o Input.o Matrix.o StatisticalFunctions.o InternalCoords.o FileIO.o Output.o DCDFiles.o DCDHeader.o FreeEnergy.o ArrayUtil.o
Fep2D:    Fep2D.o Analysis.o Output.o StatisticalFunctions.o Input.o Data.o FreeEnergy.o FileIO.o Log.o DCDFiles.o Matrix.o InternalCoords.o DCDHeader.o ArrayUtil.o Util.o
